...
//import itec3030.smarthome.standards.________;
...
public class Room {
    ...
    private ArrayList<NumericMeasurementInstrument> tempSensors = new ArrayList<>();
     ...
     */
    public void install(NumericMeasurementInstrument t){
        tempSensors.add(t);
    }
    ...
    public float getAvergeTemperature(){
        float count = 0;
        float sum = 0;
        for (NumericMeasurementInstrument s: tempSensors){
            sum += s.getReading();
            count++;
        }
